...
public class Users {
    ...
    private OrangeMingWen myOraIns[]=new OrangeMingWen[10];
    private BlueMingWen myBluIns[]=new BlueMingWen[10];
    private GreenMingWen myGreIns[]=new GreenMingWen[10];
    ...
    public void setOraIns(OrangeMingWen oraIns)
    {
        if(oraIndex>=10)
        {
    ...
    public void setBluIns(BlueMingWen bluIns)
    {
        if(bluIndex>=10)
        {
    ...
    public void setGreIns(GreenMingWen greIns)
    {
        if(greIndex>=10)
        {
    ...
    public void choiceIns(Scanner sc,OrangeMingWen[]oraIns,BlueMingWen[]bluIns,GreenMingWen[]greIns) //选择铭文
    {
        int color;
        int type;
        int level;
